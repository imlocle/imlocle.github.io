...
export const EXPERIENCE: Experience[] = [
  {
    ...
    location: 'Remote',
    description: 'Leading backend development for cloud-native SaaS platform supporting 10K+ iOS users',
    achievements: [
...
export const SKILLS = {
  ...
  cloud: {
    aws: ['Lambda', 'API Gateway', 'DynamoDB', 'S3', 'CloudWatch', 'Bedrock', 'Cognito'],
