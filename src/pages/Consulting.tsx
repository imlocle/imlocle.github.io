    ...
    <div className="consulting-container">
      ...
      <section className="work-on-section">
        ...
        <p className="section-intro">
          I focus on projects where deep technical expertise makes a significant
          impact:
        </p>
      ...
      <section className="investment-section">
        ...
        <div className="investment-card">
          <p className="investment-text">
            Projects typically range from <strong>$15K - $50K</strong> depending
            on scope and complexity. I don&apos;t publish fixed pricing because
            every system is different.
          </p>
          <p className="investment-text">
            We&apos;ll discuss your specific needs and I&apos;ll provide a
