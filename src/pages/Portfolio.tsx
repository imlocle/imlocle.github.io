    ...
    const projects: Project[] = [
        {
            ...
            outcomes: 'Designed and deployed a scalable AWS backend capable of handling millions of video uploads daily, improving system reliability and performance.',
        ...
        },
        {
            ...
            outcomes: 'Built a fully responsive React + Vite site with AI-powered project previews, enabling clients to quickly understand my consulting capabilities.',
        ...
        },
        {
            ...
            description: 'An AI chatbot using AWS Bedrock and Python that answers questions about me.',
            outcomes: 'Built a fully functional AI chatbot using AWS Bedrock, implementing a custom rate limiter to efficiently handle multiple users and ensure stable performance.',
